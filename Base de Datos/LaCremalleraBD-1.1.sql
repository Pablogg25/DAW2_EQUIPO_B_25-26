...
-- Usuarios
INSERT INTO usuarios (nombre, telefono, email, direccion, username, password, rol)
VALUES
('Laura Martínez', '600111222', 'laura@cremallera.com', 'C/ Sol 12', 'laura_adm', CONCAT(LEFT('laura_adm',3), LEFT('admin',3)), 'admin'),
('Pablo Rivas', '600222333', 'pablo@cremallera.com', 'C/ Luna 33', 'pablo_adm', CONCAT(LEFT('pablo_adm',3), LEFT('admin',3)), 'admin'),
('Sergio López', '600333444', 'sergio@cremallera.com', 'C/ Río 21', 'sergio_emp', CONCAT(LEFT('sergio_emp',3), LEFT('empleado',3)), 'empleado'),
('Gustavo Bautista', '600444555', 'gustavo@cremallera.com', 'C/ Águila 2', 'gustavo_emp', CONCAT(LEFT('gustavo_emp',3), LEFT('empleado',3)), 'empleado'),
('Pablo Núñez', '600555666', 'pablo.nunez@cremallera.com', 'C/ Olivo 19', 'pablo_emp', CONCAT(LEFT('pablo_emp',3), LEFT('empleado',3)), 'empleado'),
('Ana Torres', '600666777', 'ana@gmail.com', 'Av. Castilla 9', 'ana_cli', CONCAT(LEFT('ana_cli',3), LEFT('cliente',3)), 'cliente'),
('Carlos Pérez', '600777888', 'carlos@gmail.com', 'C/ Mayor 41', 'carlos_cli', CONCAT(LEFT('carlos_cli',3), LEFT('cliente',3)), 'cliente'),
('María López', '600888999', 'maria@gmail.com', 'C/ Prado 15', 'maria_cli', CONCAT(LEFT('maria_cli',3), LEFT('cliente',3)), 'cliente'),
('Jorge Díaz', '600999111', 'jorge@gmail.com', 'C/ Jardines 4', 'jorge_cli', CONCAT(LEFT('jorge_cli',3), LEFT('cliente',3)), 'cliente'),
('Elena Ruiz', '611222333', 'elena@gmail.com', 'C/ Sur 28', 'elena_cli', CONCAT(LEFT('elena_cli',3), LEFT('cliente',3)), 'cliente');
-- Prendas
